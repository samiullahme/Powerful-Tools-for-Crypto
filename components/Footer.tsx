        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-1 flex flex-col">
            ...
            <div className="flex items-center gap-4 mt-auto">
              <Link href="#" aria-label="Email" className="text-slate-400 hover:text-white transition-colors bg-white/5 p-2 rounded-full border border-white/10 hover:bg-white/10">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              <li><Link href="#" className="text-[13px] text-slate-400 hover:text-white transition-colors">About Us</Link></li>
              <li><Link href="#" className="text-[13px] text-slate-400 hover:text-white transition-colors">Blog</Link></li>
              <li><Link href="#" className="text-[13px] text-slate-400 hover:text-white transition-colors">Contact Us</Link></li>
              <li><Link href="#" className="text-[13px] text-slate-400 hover:text-white transition-colors">Sitemap</Link></li>
              <li>
                <Link href="#" className="text-[13px] text-slate-400 hover:text-white transition-colors flex items-center gap-1">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              <li><Link href="#" className="text-[13px] text-slate-400 hover:text-white transition-colors">Privacy Policy</Link></li>
              <li><Link href="#" className="text-[13px] text-slate-400 hover:text-white transition-colors">Terms of Use</Link></li>
              <li><Link href="#" className="text-[13px] text-slate-400 hover:text-white transition-colors">Cookie Policy</Link></li>
              <li><Link href="#" className="text-[13px] text-slate-400 hover:text-white transition-colors">Disclaimer</Link></li>
              <li><Link href="#" className="text-[13px] text-slate-400 hover:text-white transition-colors">DMCA Policy</Link></li>
              <li><Link href="#" className="text-[13px] text-[#FF9500] hover:text-orange-400 transition-colors font-medium">Advertise with Us</Link></li>
            </ul>
          </div>
